...
export function CookingMode() {
  ...
  return (
    <div className="fixed inset-0 bg-stone-950 text-white z-50 flex flex-col max-w-md md:max-w-2xl lg:max-w-4xl mx-auto">
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto p-6 flex flex-col justify-center relative">
        ...
        >
          <div className="flex flex-col items-center gap-3">
            <h2 className={cn(
              "text-2xl md:text-3xl font-bold leading-tight transition-all duration-300 flex items-center justify-center gap-3",
          ...
          {/* Timer Module */}
          <div className="bg-stone-900 rounded-3xl p-6 border border-stone-800 max-w-xs mx-auto relative">
            <div className="relative w-56 h-56 mx-auto mb-6 flex items-center justify-center">
              ...
              <div className="flex flex-col items-center justify-center z-10">
                <div className="text-5xl font-mono font-light tracking-tighter text-orange-500">
                  {formatTime(timeLeft)}
                </div>
              </div>
              ...
              <div className="absolute inset-0 flex items-center justify-between px-2 z-20 pointer-events-none">
                <button 
                  ...
                  className="w-10 h-10 rounded-full bg-stone-800 text-stone-400 flex items-center justify-center hover:bg-stone-700 hover:text-white transition-colors pointer-events-auto shadow-lg"
            ...
            <div className="flex justify-center gap-6 mb-8">
              <button 
                ...
                className={cn(
                  "w-20 h-20 rounded-full text-white flex items-center justify-center transition-all shadow-xl",
                  isTimerRunning ? "bg-stone-800 hover:bg-stone-700" : "bg-orange-500 hover:bg-orange-600 shadow-orange-500/20"
                )}
              >
                {isTimerRunning ? <Pause className="w-8 h-8 fill-current" /> : <Play className="w-8 h-8 fill-current ml-1.5" />}
              </button>
              <button 
                onClick={() => {
                  setIsTimerRunning(false);
                ...
                className="w-20 h-20 rounded-full bg-stone-800 text-stone-400 flex items-center justify-center hover:bg-stone-700 transition-colors shadow-lg"
              >
      ...
      <div className="p-6 bg-stone-950 border-t border-stone-800 pb-safe flex flex-col gap-4">
        ...
        <motion.button 
          whileTap={{ scale: 0.95 }}
          animate={isCompleted ? { backgroundColor: "#292524", color: "#a8a29e" } : { backgroundColor: "#16a34a", color: "#ffffff" }}
          transition={{ duration: 0.3 }}
          onClick={toggleStepComplete}
          className={cn(
            "w-full h-16 rounded-2xl flex items-center justify-center gap-3 text-lg font-bold mb-6 overflow-hidden relative",
            !isCompleted && "hover:bg-green-500"
          )}
        >
